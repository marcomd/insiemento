...
ActiveRecord::Schema.define(version: 20_211_002_161_612) do
  ...
  create_table 'course_events', force: :cascade do |t|
    ...
    t.integer 'attendees_count', limit: 2, default: 0, null: false
  ...
  create_table 'subscriptions', force: :cascade do |t|
    ...
    t.index %w[start_on end_on], name: 'index_subscriptions_on_start_on_and_end_on'
