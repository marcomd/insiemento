...
if Organization.count == 0
  o_dance = Organization.create(name: 'Dance school', payoff: 'Run, Jump, Burn!',
                                email: 'support@danceschool.io', phone: '0211223344',
                                domain: 'danceschool.io', state: :active,
                                theme: {
                                  dark_mode: false,
  ...
  o_dance, o_others = Organization.all
end
...
if CourseSchedule.count == 0
  ...
  [1,2,3,4,5,6,0].each do |event_day|
    course_event_attributes << {organization_id: o_dance.id, course_id: c_zumba.id,   room_id: r_small.id,  trainer_id: t_miguel.id, event_day: event_day, event_time: '7:00', state: :active}
    course_event_attributes << {organization_id: o_dance.id, course_id: c_zumba.id,   room_id: r_middle.id, trainer_id: t_miguel.id, event_day: event_day, event_time: '10:00', state: :active}
    course_event_attributes << {organization_id: o_dance.id, course_id: c_zumba.id,   room_id: r_large.id,  trainer_id: t_miguel.id, event_day: event_day, event_time: '13:00', state: :active}
    course_event_attributes << {organization_id: o_dance.id, course_id: c_yoga.id,    room_id: r_small.id,  trainer_id: t_jenny.id,  event_day: event_day, event_time: '14:30', state: :active}
    course_event_attributes << {organization_id: o_dance.id, course_id: c_yoga.id,    room_id: r_middle.id, trainer_id: t_jenny.id,  event_day: event_day, event_time: '16:30', state: :active}
    course_event_attributes << {organization_id: o_dance.id, course_id: c_yoga.id,    room_id: r_large.id,  trainer_id: t_jenny.id,  event_day: event_day, event_time: '18:30', state: :active}
    course_event_attributes << {organization_id: o_dance.id, course_id: c_pilates.id, room_id: r_large.id,  trainer_id: t_sandy.id,  event_day: event_day, event_time: '21:00', state: :active}
  end
