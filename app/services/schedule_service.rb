...
class ScheduleService
  ...
  def call
    ...
    CourseSchedule.active.order('event_day, event_time, course_id').each do |cs|
      # ce = {  organization_id: cs.organization_id,category_id: cs.category_id,course_id: cs.course_id,room_id: cs.room_id,trainer_id: cs.trainer_id,course_schedule_id: cs.id,event_date: cs.next_event_datetime(progressive_date),state: cs.state}
